...
### Notable Active Repos (recent pushes 2026)

- **plurigrid/gorj** (Clojure) — `forj + Rama topology nREPL routing + GF(3) gay trit coloring` — 810 open issues, pushed 2026-06-25
- **plurigrid/eirobri** (Clojure) — EiRoBri replay world — 30 open issues, pushed 2026-06-23
- **plurigrid/place** (TeX) — pushed 2026-06-24
- **bmorphism/Gay.jl** (Julia) — Wide-gamut color sampling with SPI — 187 open issues, pushed 2026-06-25
- **TeglonLabs/jank-crane** (C++) — crane-jank converged-IR hub: GF3 convergence maps — pushed 2026-06-08
- **kubeflow/docs-agent** (Python) — pushed 2026-06-25
- **zubyul/gay-world** (Python) — Goblin world builder + MLX task decomposition — pushed 2026-03-26
...
**Result:** All accounts returned no CoinStore resource — balances are **null** (accounts unfunded or not yet on-chain).
...
**Status: UNAVAILABLE** — The testnet.mnx.fi domain requires Vercel authentication (password-protected deployment). All API paths returned the Vercel auth wall. No market data could be extracted.
...
<!-- Previous sweep preserved below -->
## Sweep Metadata (prior run 2026-04-12)
- **Date:** 2026-04-12
