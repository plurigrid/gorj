...
**Sweep Date/Time:** 2026-03-30T16:22 UTC
...
| bmorphism | user | 100 |
| zubyul | user | 23 |
| migalkin | user_social (zubyul graph) | 30 |
| DJedamski | user_social (zubyul graph) | 11 |
| wasita | user_social (zubyul graph) | 2 |
| kristinezheng | user_social (zubyul graph) | 18 |
| M1shaaa | user_social (zubyul graph) | 16 |
| AustinCStone | user_social (zubyul graph) | 43 |
| bmorphism events | public events (30) | 30 events |
| zubyul events | public events (30) | 30 events |

**Total repos captured:** 442
**Total event rows:** 60
**Total repo_snapshots rows (this run):** 500 (incl. events)

### GF(3) Color Chain Summary

| Increment ID | Source | GF(3) Trit | Color | Hex |
|---|---|---|---|---|
| 1 | org:plurigrid | 1 | PLUS | #b8bb26 |
| 2 | org:kubeflow | -1 | MINUS | #cc241d |
| 3 | org:TeglonLabs | 0 | ERGODIC | #d3869b |
| 4 | user:bmorphism | 1 | PLUS | #b8bb26 |
| 5 | user:zubyul | -1 | MINUS | #cc241d |
| 6 | user_social:migalkin | 0 | ERGODIC | #d3869b |
| 7 | user_social:DJedamski | 1 | PLUS | #b8bb26 |
| 8 | user_social:wasita | -1 | MINUS | #cc241d |
| 9 | user_social:kristinezheng | 0 | ERGODIC | #d3869b |
| 10 | user_social:M1shaaa | 1 | PLUS | #b8bb26 |
| 11 | user_social:AustinCStone | -1 | MINUS | #cc241d |
| 12 | events:bmorphism | 0 | ERGODIC | #d3869b |
| 13 | events:zubyul | 1 | PLUS | #b8bb26 |
...
All 28 addresses queried via Aptos mainnet fullnode. All returned `resource_not_found` for `0x1::coin::CoinStore<0x1::aptos_coin::AptosCoin>`, indicating zero APT balance (no coin store initialized).
...
- `https://api.dev.mnx.fi/markets` - Cannot GET /markets

MNX testnet markets API is not reachable at this time. No data inserted into `mnx_snapshots`.
