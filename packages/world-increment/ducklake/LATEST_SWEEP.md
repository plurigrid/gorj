...
| **TOTAL** | | **389 unique repos** |

### Top Repos by Stars

| Repo | Stars | Language | Last Push |
|---|---|---|---|
| kubeflow/pipelines | 4132 | Python | 2026-05-05 |
| kubeflow/trainer | 2096 | Go | 2026-05-05 |
...
### Recently Active Repos (2026-04 and newer)

| Repo | Language | Pushed |
|---|---|---|
| bmorphism/Gay.jl | Julia | 2026-05-05 |
| plurigrid/zig-syrup | Zig | 2026-04-30 |
| bmorphism/boxxy | Move | 2026-04-30 |
| plurigrid/asi | HTML | 2026-04-26 |
| zubyul/voice-observatory | Python | 2026-04-24 |
| zubyul/ghostel-emacs-worlds | GLSL | 2026-04-24 |
| wasita/wasita.github.io | Svelte | 2026-04-28 |
| AustinCStone/StereoVisionMRF | Python | 2026-04-01 |

### GF(3) Color Distribution (340 increments)
...
### Language Distribution (by star weight)
...
All balances returned **0.00 APT** — CoinStore resource not initialized on mainnet for these addresses.
...
All 5/5 multisig contracts healthy — 2-of-N threshold confirmed active.

### MNX Markets (testnet.mnx.fi)

**Status: SPA-only / API unavailable**  
`testnet.mnx.fi` is a Next.js single-page application. All probed API paths (`/api/markets`, `/api/v1/markets`) return the HTML shell; no structured market data is extractable without browser JS execution. `mnx_snapshots` table is empty for this run.

---

## DuckDB Ducklake Schema Summary

Database: `packages/world-increment/ducklake/world-increments.duckdb`

| Table | Rows | Description |
|---|---|---|
| `world_increments` | 340 | GF(3)-tagged increment ledger (per-repo events) |
| `repo_snapshots` | 1,261 | Full GitHub repo metadata snapshots |
| `aptos_snapshots` | 28 | Hamming swarm APT balances (alice, bob, A–Z) |
| `multisig_probes` | 5 | Multisig contract health (all 2-sig, all HEALTHY) |
| `mnx_snapshots` | 0 | MNX market data (unavailable — SPA) |
...
*Run: 2026-05-05 | DuckDB v1.5.2 Variegata | Sources: 3 orgs + 8 users*
