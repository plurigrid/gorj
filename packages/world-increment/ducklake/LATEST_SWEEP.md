...
**Sweep timestamp:** 2026-06-03T00:00:00Z  
...
|----|------|-------|------|--------|
| 1 | +1 | `#b8bb26` PLUS | org:plurigrid | 21 repos |
| 2 | -1 | `#cc241d` MINUS | org:kubeflow | 18 repos |
| 3 | 0 | `#d3869b` ERGODIC | org:TeglonLabs | 4 repos |
| 4 | +1 | `#b8bb26` PLUS | user:bmorphism | 18 repos |
| 5 | -1 | `#cc241d` MINUS | user:zubyul | 10 repos |
| 6 | 0 | `#d3869b` ERGODIC | user:migalkin | 5 repos |
| 7 | +1 | `#b8bb26` PLUS | user:wasita | 5 repos |
| 8 | -1 | `#cc241d` MINUS | user:AustinCStone | 5 repos |
| 9 | 0 | `#d3869b` ERGODIC | user:DJedamski | 4 repos |
| 10 | +1 | `#b8bb26` PLUS | user:kristinezheng | 3 repos |
| 11 | -1 | `#cc241d` MINUS | user:M1shaaa | 3 repos |

**Total:** 11 increments · 96 repo snapshots
...
- **plurigrid/gorj** — 311 open issues, pushed 2026-06-02 (this repo!)
- **kubeflow/dashboard** — pushed 2026-06-02
- **bmorphism/world** + **bmorphism/Gay.jl** — pushed 2026-06-02
- **plurigrid/eirobri** — 28 open issues, pushed 2026-05-26
- **plurigrid/nanoclj-zig** — 20 open issues, pushed 2026-04-25

### Social Graph: Zubyul Connections

| user | repos snapshotted | notable |
|------|-------------------|---------|
| migalkin | 5 | NodePiece (144★) — KG research, ICLR22 |
| DJedamski | 4 | R data science, Coursera/Kaggle |
| wasita | 5 | magic-garden (2★), Svelte web apps |
| kristinezheng | 3 | cognitive science, lookit studies |
| M1shaaa | 3 | lab-bookshelf TypeScript |
| AustinCStone | 5 | TextGAN (92★) — ML/AI research |
...
`0x1::coin::CoinStore<0x1::aptos_coin::AptosCoin>` at ledger ~5,540,390,105.
No CoinStore has been initialized on any of these addresses.
...
All 5 contracts healthy — each requires 2-of-N signatures.
...
The site is a Next.js SPA. No REST/JSON API endpoints responded at
`/api/markets` or `/api/v1/markets`. Market data is rendered client-side
and unavailable programmatically. `mnx_snapshots` table is empty this sweep.
...
```
world_increments:  11 rows  (GF3 trit chain per source)
repo_snapshots:    96 rows  (org/user repo metadata)
...
GF(3) color legend: trit=+1 → PLUS `#b8bb26` | trit=0 → ERGODIC `#d3869b` | trit=-1 → MINUS `#cc241d`
