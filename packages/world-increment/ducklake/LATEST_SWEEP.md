...
| Metric | Value |
|--------|-------|
| Total World Increments (cumulative) | 198 |
| Total Repo Snapshots (cumulative) | 1,119 |
...
## Notable Highlights (2026-04-12 sweep)
...
## JOB 2: Hamming Swarm Snapshot (2026-07-07)
...
**Effective balance: 0.000 APT** across the entire hamming swarm.

These addresses exist on-chain but hold no APT coin store (wallets may hold other assets or be provisioned without coin store).
...
All 5 multisigs are **2-of-2** and responding normally on Aptos mainnet.

### MNX Markets (testnet.mnx.fi)

**Status: UNAVAILABLE** — `https://testnet.mnx.fi` returns HTTP 401 Unauthorized.
Both root URL and `/api/markets` path require authentication. No market data extracted this sweep.

---

## Delta: April 12 → July 7, 2026

| Metric | Apr 12 | Jul 7 | Delta |
|--------|--------|-------|-------|
| kubeflow/kubeflow stars | 15,565 | 15,769 | +204 |
| kubeflow/pipelines stars | 4,119 | 4,169 | +50 |
| kubeflow/spark-operator stars | 3,111 | 3,133 | +22 |
| kubeflow/trainer stars | 2,080 | 2,130 | +50 |
| bmorphism/ocaml-mcp-sdk stars | 60 | 61 | +1 |
| bmorphism/anti-bullshit stars | 23 | 23 | 0 |
| migalkin/NodePiece stars | 143 | 144 | +1 |
| New kubeflow repos | — | hub, mlflow-integration, docs-agent | +3 |
