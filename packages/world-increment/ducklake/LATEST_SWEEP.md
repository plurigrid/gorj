...
**Sweep timestamp:** 2026-06-10 UTC  
**GF3 color chain sweep:** IDs 13–23 across 11 sources
...
|----|-----|-------|--------|------|-------|
| 13 | +1 (PLUS) | #b8bb26 | plurigrid | org | 100 |
| 14 | -1 (MINUS) | #cc241d | kubeflow | org | 48 |
| 15 | 0 (ERGODIC) | #d3869b | bmorphism | user | 100 |
| 16 | +1 (PLUS) | #b8bb26 | zubyul | user | 49 |
| 17 | -1 (MINUS) | #cc241d | TeglonLabs | org | 5 |
| 18 | 0 (ERGODIC) | #d3869b | migalkin | user | 6 |
| 19 | +1 (PLUS) | #b8bb26 | DJedamski | user | 3 |
| 20 | -1 (MINUS) | #cc241d | wasita | user | 3 |
| 21 | 0 (ERGODIC) | #d3869b | kristinezheng | user | 3 |
| 22 | +1 (PLUS) | #b8bb26 | M1shaaa | user | 2 |
| 23 | -1 (MINUS) | #cc241d | AustinCStone | user | 5 |

**Total repos snapshotted this sweep:** 324  
**Cumulative repo_snapshots in ducklake:** 1268  
**Cumulative world_increments:** 34

### Top Starred Repos (this sweep)

```
kubeflow/kubeflow           15715 stars
kubeflow/pipelines           4153 stars  Python
kubeflow/spark-operator      3126 stars  Python
kubeflow/trainer             2112 stars  Go
kubeflow/katib               1685 stars  Python
kubeflow/examples            1462 stars  Jsonnet
kubeflow/manifests           1022 stars  YAML
kubeflow/arena                812 stars  Go
kubeflow/kale                 693 stars  Python
kubeflow/mpi-operator         528 stars  Go
migalkin/NodePiece             144 stars  Python
AustinCStone/TextGAN            92 stars  Python
migalkin/StarE                  89 stars  Python
AustinCStone/StereoVisionMRF    11 stars  Python
```

### Notable Highlights
- **TeglonLabs/jank-crane** (2026-06-08): crane-jank converged-IR hub with GF3 convergence maps — most recently pushed repo in sweep
...
- **plurigrid**: 100 repos captured (at search limit)
- **bmorphism**: 100 repos captured (at search limit)
...
**All 28 wallets (alice, bob, A-Z): 0.0 APT**  
Addresses are registered on Aptos mainnet but hold no liquid APT balance.
...
**All 5 multisig contracts healthy** - 2-of-N signature threshold confirmed live on Aptos mainnet via 0x1::multisig_account::num_signatures_required.

### MNX Testnet Markets

**Status: Unavailable (authentication required)**  
https://testnet.mnx.fi returns HTTP 401 for all API paths probed:
- /api/markets
- /api/v1/markets
- /api/tickers
