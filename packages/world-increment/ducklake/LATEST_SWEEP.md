...
| Metric | Value |
|--------|-------|
| Total World Increments | 146 |
| Total Repo Snapshots | 146 |
...
|--------|------|-------|-------------|
| plurigrid | org | 99 | 63 |
| bmorphism | user | 13 | 188 |
| zubyul | user | 8 | 1 |
| migalkin | social | 5 | 273 |
| wasita | social | 5 | 1 |
| TeglonLabs | org | 4 | 2 |
...
| bmorphism/babashka-mcp-server | JavaScript | 18 | 2026-03-26 |
| migalkin/manifold-mcp-server | JavaScript | 13 | 2025-12-30 |
...
| plurigrid/gorj | Clojure | 0 | 2026-04-14 |
...
The `0x1::coin::CoinStore<0x1::aptos_coin::AptosCoin>` resource was absent
for all addresses — consistent with fresh/unfunded accounts on mainnet.
...
**Total APT across all 28 swarm worlds:** 0.0 APT

### Multisig Contract Probes (5 pairs)

All 5 multisig accounts are **healthy** — 2-of-2 threshold confirmed on Aptos mainnet.
...
**Status: Unavailable** — `testnet.mnx.fi` is a Next.js SPA. API paths `/api/markets`
and `/api/tickers` return HTML (no public REST endpoint). No market data extracted.
...
world_increments(id, timestamp, gf3_trit, gf3_color, gf3_name,
                 ...
                 actor, snapshot_hash)                            -- 146 rows

repo_snapshots(id, timestamp, increment_id, org_or_user, repo_name,
               full_name, language, stars, forks, open_issues,
               pushed_at, description)                            -- 146 rows
...
mnx_snapshots(timestamp, ticker, name, category, price, change_pct) -- 1 row (unavailable)
```
...
*Generated by world-increment-sweep + hamming-swarm-snapshot agent, 2026-04-14*
