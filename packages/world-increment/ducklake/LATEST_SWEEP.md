...
GF(3) chain: `ERGODIC → PLUS → MINUS → ERGODIC → PLUS → MINUS → ...` (335 steps, balanced trit distribution)

### Top Repos by Stars (this sweep)

| Repo | Stars | Language | Pushed |
|------|-------|----------|--------|
| kubeflow/kubeflow | 15,761 | — | 2026-06-18 |
| kubeflow/pipelines | 4,169 | Python | 2026-07-03 |
...
- **plurigrid/gorj** (Clojure) — pushed 2026-07-04 (this repo)
- **plurigrid/shrimp** — pushed 2026-07-03
- **plurigrid/asi** (HTML, ⭐28) — pushed 2026-06-29 (up from ⭐16 at last sweep)
- **plurigrid/eirobri** (Clojure) — pushed 2026-06-30
- **bmorphism/Gay.jl** (Julia, ⭐2) — pushed 2026-07-04
- **bmorphism/ocaml-mcp-sdk** (OCaml, ⭐61) — up from ⭐60
- **kubeflow/hub** (Go, ⭐173) — pushed 2026-07-04
...
All 28 Hamming-swarm addresses probed against `0x1::coin::CoinStore<0x1::aptos_coin::AptosCoin>`.

**Result:** All 28 addresses return "Resource not found" — no APT CoinStore registered.  
...
**All 5/5 multisigs healthy — uniform 2-of-2 threshold.**

### MNX Markets (testnet.mnx.fi)

API paths probed: `/api/markets`, `/api/v1/markets`, `/markets`, `/api/tickers`

**Result:** All paths return 13,462 bytes of HTML (SPA shell). No REST market data available. Recorded as unavailable; `mnx_snapshots` table remains empty.
