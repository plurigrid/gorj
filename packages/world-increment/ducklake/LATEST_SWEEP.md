...
| Metric | Value |
|--------|-------|
| Total World Increments | 261 |
| Total Repo Snapshots | 1,152 |
...
- **zubyul events**: 30 recent PushEvents all targeting `plurigrid/bci-blue-share`
- **bmorphism**: most recently pushed 2026-04-19 (active today)
...
**All balances: 0 APT** — addresses are unfunded on mainnet as of this sweep.
...
All 5 multisig contracts responded healthy with 2-of-N signature requirements.
...
**Status: Unavailable.** The testnet.mnx.fi SPA did not expose accessible API endpoints at `/api/markets`, `/api/v1/markets`, or `/api/tickers`. Stored as unavailable sentinel row in `mnx_snapshots`.
