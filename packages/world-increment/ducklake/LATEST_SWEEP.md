...
| Source | Type | Repos | Top Stars | GF3 Color | GF3 Name |
|--------|------|-------|-----------|-----------|----------|
| plurigrid | org | 100 | 24 | #b8bb26 | PLUS |
| kubeflow | org | 48 | 15705 | #cc241d | MINUS |
| bmorphism | user | 100 | 61 | #d3869b | ERGODIC |
| zubyul | user | 49 | 2 | #b8bb26 | PLUS |
| migalkin | user | 19 | 144 | #cc241d | MINUS |
| AustinCStone | user | 40 | 92 | #d3869b | ERGODIC |
| wasita | user | 11 | 2 | #b8bb26 | PLUS |
| TeglonLabs | org | 4 | 2 | #cc241d | MINUS |
| DJedamski | user | 6 | 1 | #d3869b | ERGODIC |
| kristinezheng | user | 6 | 0 | #b8bb26 | PLUS |
| M1shaaa | user | 8 | 0 | #cc241d | MINUS |

**Total:** 391 repos snapshotted across 11 sources
...
| kubeflow/pipelines | 4151 |
| kubeflow/spark-operator | 3125 |
| kubeflow/trainer | 2110 |
| kubeflow/katib | 1685 |
| kubeflow/examples | 1462 |
| kubeflow/manifests | 1020 |
| kubeflow/arena | 811 |
| kubeflow/kale | 691 |
...
GF(3): `id%3==0 → trit=0 ERGODIC #d3869b` | `id%3==1 → trit=1 PLUS #b8bb26` | `id%3==2 → trit=-1 MINUS #cc241d`

---

## JOB 2: Hamming Swarm Snapshot

### Aptos Wallet Balances (2026-06-03)

All 28 wallets queried via Aptos mainnet fullnode CoinStore resource API.

**Result:** All 28 addresses (alice, bob, A-Z) returned **0.0 APT** — no active CoinStore resource found (wallets are uncreated/unfunded on mainnet).
...
`testnet.mnx.fi` is a Next.js SPA. API paths `/api/markets` and `/api/v1/markets` return HTML (no JSON). Market data requires client-side JavaScript rendering.

**Status:** UNAVAILABLE via direct HTTP probe (SPA with no REST API)
...
| repo_snapshots | 391 | Full metadata per repo |
| aptos_snapshots | 28 | alice, bob, A-Z wallets |
| multisig_probes | 5 | All pairs healthy (2 sigs) |
