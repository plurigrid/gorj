...
| TeglonLabs | org | ✅ 49 repos captured |
| kubeflow | org | ⚠️ rate-limited (partial) |
| bmorphism | user | ⚠️ rate-limited |
| zubyul | user | ⚠️ rate-limited |
| migalkin | user (zubyul graph) | ⚠️ rate-limited |
| DJedamski | user (zubyul graph) | ⚠️ rate-limited |
| wasita | user (zubyul graph) | ⚠️ rate-limited |
| kristinezheng | user (zubyul graph) | ✅ 5 repos |
| M1shaaa | user (zubyul graph) | ⚠️ rate-limited |
| AustinCStone | user (zubyul graph) | ⚠️ rate-limited |

> GitHub unauthenticated API rate limit (60 req/hr) exhausted after plurigrid + TeglonLabs.

### GF(3) Color Chain — This Sweep (104 increments)
...
### plurigrid Highlights (top repos by activity)
| Repo | Language | Stars | Forks | Last Push |
|------|----------|-------|-------|-----------|
| gorj | Clojure | 0 | 0 | 2026-05-10 |
| horse | TeX | 1 | 1 | 2026-05-07 |
| zig-syrup | Zig | 2 | 2 | 2026-04-30 |
| UnwiringDiagrams.jl | Julia | 1 | 0 | 2026-04-26 |
| asi | HTML | 21 | 5 | 2026-04-26 |
| nash-portal | Rust | 2 | 2 | 2026-04-26 |
| nanoclj-zig | Zig | 1 | 2 | 2026-04-25 |

### TeglonLabs Highlights (top repos)
| Repo | Language | Stars | Last Push |
|------|----------|-------|-----------|
| Stahl | Rust | 0 | 2026-01-16 |
| mathpix-gem | Ruby | 2 | 2026-01-01 |
| duck-ui | — | 0 | 2025-10-19 |
| acp.el | — | 1 | 2025-09-28 |
| vibespace | HTML | 2 | 2025-06-24 |

### kristinezheng Highlights
| Repo | Language | Last Push |
|------|----------|-----------|
| kristinezheng.github.io | HTML | 2026-04-09 |
| hierarchical-teaching | JavaScript | 2025-04-11 |
| pddlgym | — | 2025-07-22 |

### DuckDB Ducklake Cumulative State
```
world_increments : 127 rows  (cumulative across sweeps)
repo_snapshots   : 476 distinct repos (cumulative)
aptos_snapshots  : 28 rows   (this sweep)
multisig_probes  : 5 rows    (this sweep)
mnx_snapshots    : 1 row     (this sweep)
```
...
Queried via `https://fullnode.mainnet.aptoslabs.com` — 1s sleep between calls.
...
> All 28 accounts return 0 APT. Accounts may be uninitialized (no `CoinStore<AptosCoin>` resource) on mainnet.
...
All 5 multisig contracts respond on-chain with `sigs_required=2` (2-of-N threshold). All healthy.

### MNX Markets (testnet.mnx.fi)
- Status: **UNAVAILABLE** — Next.js SPA, no server-rendered API.
- Endpoints probed: `/api/markets`, `/api/v1/markets` — both return full HTML SPA shell.
...
*Generated by world-increment-sweep + hamming-swarm-snapshot agent · 2026-05-10*
