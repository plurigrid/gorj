...
| bmorphism | user | 100 | 240 | 2026-06-28 |
| zubyul | user | 49 | 14 | 2026-04-24 |
| kubeflow | org | 48 | 34,272 | 2026-06-27 |
| migalkin | user | 40 | 108 | 2026-02-11 |
| wasita | user | 11 | 5 | 2026-06-25 |
| M1shaaa | user | 8 | 0 | 2026-06-28 |
...
GF(3) chain: `PLUS → MINUS → ERGODIC → (repeats)` — 124 full cycles + 3 partial

### Notable Repos (this sweep)

- **kubeflow/kubeflow** — dominant at 34k+ stars (flagship ML platform for Kubernetes)
- **TeglonLabs/jank-crane** — C++, GF3 convergence maps, pushed 2026-06-08
- **TeglonLabs/mathpix-gem** — Ruby mathpix gem, 2 stars, 11 open issues (most active TeglonLabs)
- **bmorphism** — 100 repos, 240 total stars, latest activity today
- **M1shaaa/M1shaaa** — profile repo pushed 2026-06-28 03:29 UTC (today)
...
Snapshot: 2026-06-28 UTC | API: `https://fullnode.mainnet.aptoslabs.com/v1`

All 28 Hamming world addresses (alice, bob, A–Z) report **0.0 APT** from the `CoinStore<AptosCoin>` resource. Accounts are either unfunded at mainnet or hold assets under other resource types.
...
All 5 multisig contracts are **healthy** with 2-of-N signing threshold.
...
**Status: Unavailable** — `https://testnet.mnx.fi` returns Vercel deployment protection (authentication required). No market data accessible without a bypass token or Vercel auth configuration.

---

## DuckDB Summary (cumulative)

| Table | Total Rows |
|-------|-----------|
| world_increments | 395 |
| repo_snapshots | 1,316 |
| aptos_snapshots | 28 |
| multisig_probes | 5 |
| mnx_snapshots | 1 (unavailable record) |

This sweep added **372 new repo snapshots**, **28 Aptos wallet snapshots**, and **5 multisig probe records**.
